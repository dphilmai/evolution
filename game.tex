...
Following \cite[57]{schelling_strategy_1960}, one may argue that 
...
dilemma as they could not reach the outcome with higher payoff for them of
them. Or are they able to recognize the Payoff-dominance of stag hunting, 
trusting each other not to react to a hare passing by.
Indeed, there is no clear consent which equilibrium will be played. 
...
because "an agreement to do so is self-stabilizing". In contrast to that,
\textcite{aumann_nash_1990} points out that a message from player 1 to

On the hand, Harsanyi, as Aumann, later advocates in \cite{harsanyinew} 
