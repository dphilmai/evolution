...
\label{replicator}. \todo{Introduce the notation and terms of a dynamical system}
...
\cite{whenandwhy}. The literature mainly concentrated on structural characterstics
of the payoff matrix \cite{whenandwhy}. For example \cite{schmidt_playing_2003}
let individuals play different stag hunt games with a varying degree
of payoff-dominance and risk-dominance. This definitions are needed to
compare games and hold effects constant\footnote{Since payoff-dominance and risk-dominance 
are usually defined within a game and not useful to discriminate between games. See also
\cite{schmidt_playing_2003}}. They define the payoff-dominance 
characteristic P of a game as the difference in payoffs between the two 
equilibria relative to the payoff of the payoff-dominant equilibrium
\begin{align}
        P = \frac{F(e_1,e_1) -F(e_2,e_2)}{F(e_1,e_2)}=1-\frac{d}{a}.
        \label{ostrompayoffdom}
\end{align} 
Measuring the degree of risk-dominance, they use a method by Selten \todo{Axiomatic Theory 
of a Risk Dominance Measure for Bipolar Games with Linear Incentives}
\begin{align}
        R = ln\left(\frac{a-c}{d-b}\right)
        \label{ostromriskdom}
\end{align}
Based on this measures, they find that individuals respond rather to changes
in the risk measure than to the payoff-dominance. Indeed, the hypothesis 
of an increasing risk measurement leading to a higher choice of  the strategy
in the risk-dominant equilibrium can be concluded from the evidence.
However, the appropriate choice of risk measure is not quite clear. 
\cite{DubioisWillingerVan} propose the concept of 'relative riskiness'. 
