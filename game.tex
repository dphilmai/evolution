...
Even though the evolutionary refinement ESS does not help as a selection
criterion in this case, the dynamic evolutionary framework, specified in the
next section, adds to the question which equilibrium is played.
...
group of player, repeatedly matched in pairs, play the stag hunt 
