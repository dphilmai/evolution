...
used in the plots, $\alpha_1 =1, \alpha_2=3$ and now let $\beta=3$. 
The basin of attraction is not equal, since $3<\beta^*=4$. 
The open source equilibrium attracts all trajectories starting within 
$x_0 \in (2+\sqrt{7},1]$ and hence the propriertary equilibrium attracts
all trajectories $x_0 \in [0,2+\sqrt{7})$. Clearly, the latter basin of 
attraction is larger, but the open source equilibrium gets risk-dominant for
