...
$\dot{x}_2 =  - \dot{x}_1$.
A standard form of a conditional switching rate $\rho_{ij}$ commonly studied
is the \textit{pairwise proportional imitiation} 
\textcite{sandholm_population_2010} suggest. It assumes, that whenever an
...
\begin{align}
        $\rho_{ij}(F_i(x),\vec{x}) = \begin{cases}
