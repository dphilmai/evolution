...
\nomenclature[F]{$F$}{Pure strategy payoff function}%
...
\nomenclature[x]{$\varphi(x)$}{The polynomial of the replicator dynamic}
...
\nomenclature[x]{$\dot{x}$}{$\frac{dx}{dt}$, Derivative with respect to time}
