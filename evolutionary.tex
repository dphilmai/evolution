...
In figure \ref{fig:basinofattraction} the graph of the replicator dynamics
...
so in fact the basin of attraction is larger for an equilibrium that 
...
initial conditions lead to the payoff-dominant equilibrium. This connection
was first shown by \textcite{kandori_learning_1993}. 
The equilibrium selection in the evolutionary stag hunt is determined by
the intial conditions.
However, it is not clear what specifies the initial conditions. 
...
likely. Otherwise, a slice of history is needed to know with which population
state the dynamic starts \textcite{friedman_economic_1998}.
