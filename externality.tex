...
evolutionary stag hunt game. Motivated by the example introduced in
...
for the personal needs. Common examples of this are Latex or Open Office
...
diminishing network externality paramter the model without 
...
leads to more cooperation, agreeing with the intuition 
